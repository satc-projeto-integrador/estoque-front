...
function ListaMovimentacao() {
    ...
    return (
        <>
            <PageHeader
                title="Lista-Movimentacao"
                extra={[
                    <Button key="lista-movimentacao" type="primary" icon={<PlusOutlined />} onClick={showModal}>Cadastrar</Button>
                ]}
            ></PageHeader>
            <DefaultPageContainer>
                ...
                <Modal title="Lista de Movimentação" open={isModalOpen} onCancel={closeModal}
                    footer={[
                    ...
                    <ListaMovimentacao  id={idSelecionado} onFinish={closeModal} />
                </Modal>
            </DefaultPageContainer>
        </>
    )
